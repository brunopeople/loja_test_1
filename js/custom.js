...
/* Atribui ao evento keypress do input data de nascimento a função para formatar o data (dd/mm/yyyy) */
var inputDataEntrada = document.getElementById("data_entrada");
if (inputDataEntrada != null && inputDataEntrada.addEventListener) {                   
    inputDataEntrada.addEventListener("keypress", function(){mascaraTexto(this, '##/##/####')});
} else if (inputDataEntrada != null && inputDataEntrada.attachEvent) {                  
    inputDataEntrada.attachEvent("onkeypress", function(){mascaraTexto(this, '##/##/####')});
}
...
/* Função para formatar dados conforme parâmetro enviado a DATA_ENTRADA e data_nascimento */
